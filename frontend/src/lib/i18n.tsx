...
const PT: Record<string, string> = {
  ...
  "Quel est votre profil ?": "Qual é o seu perfil?",
  "Je suis un usager": "Sou um utente",
  "Je possède un ou plusieurs véhicules et je gère mes démarches d'immatriculation.":
    "Possuo um ou mais veículos e trato das minhas matrículas.",
  "Accès immédiat": "Acesso imediato",
  "Je représente un corps de contrôle": "Represento uma força de controlo",
  "J'appartiens à une force de l'ordre habilitée à contrôler les véhicules.":
    "Pertenço a uma força de segurança habilitada a fiscalizar veículos.",
  "Soumis à validation": "Sujeito a validação",
  "Inscription — corps de contrôle": "Inscrição — força de controlo",
  "Votre accès sera activé après validation par un agent SNICV.":
    "O seu acesso será ativado após validação por um agente SNICV.",
  "Vous êtes un usager ?": "É um utente?",
  "Inscription usager": "Inscrição de utente",
  "Corps d'appartenance": "Força de pertença",
  "Matricule / N° de service": "Matrícula / N.º de serviço",
  "Grade": "Posto",
  "Unité / Brigade": "Unidade / Brigada",
  "Région": "Região",
  "Pièce justificative": "Documento comprovativo",
  "Carte professionnelle ou ordre de mission": "Cartão profissional ou ordem de missão",
  "PDF ou image — max 5 Mo": "PDF ou imagem — máx. 5 MB",
  "Soumettre pour validation": "Submeter para validação",
  "Joignez votre pièce justificative (carte professionnelle ou ordre de mission).":
    "Anexe o seu documento comprovativo (cartão profissional ou ordem de missão).",
  "Demande transmise": "Pedido enviado",
  "Demande refusée": "Pedido recusado",
  "Votre inscription est en cours de vérification par un agent SNICV. Vous recevrez une notification dès la décision.":
    "A sua inscrição está a ser verificada por um agente SNICV. Será notificado assim que houver decisão.",
  "Votre demande d'accès n'a pas été retenue par le service. Voir le motif ci-dessous.":
    "O seu pedido de acesso não foi aceite pelo serviço. Ver o motivo abaixo.",
  "Demande déposée": "Pedido submetido",
  "Examen agent": "Análise do agente",
  "Accès habilité": "Acesso habilitado",
  "Motif du refus": "Motivo da recusa",
  "Référence de la demande": "Referência do pedido",
  "Habilitations": "Habilitações",
  "Validez les inscriptions des corps de contrôle avant l'ouverture de leur accès.":
    "Valide as inscrições das forças de controlo antes de abrir o seu acesso.",
  "Gérer les corps": "Gerir as forças",
  "Habilités actifs": "Habilitados ativos",
  "Corps représentés": "Forças representadas",
  "Rejetées": "Recusadas",
  "Demandes d'habilitation": "Pedidos de habilitação",
  "Nom, matricule, corps…": "Nome, matrícula, força…",
  "Validées": "Validadas",
  "Toutes": "Todas",
  "Aucune demande": "Nenhum pedido",
  "Aucune demande ne correspond à ce filtre.": "Nenhum pedido corresponde a este filtro.",
  "Corps": "Força",
  "Matricule": "Matrícula",
  "Déposée le": "Submetido em",
  "Examiner": "Examinar",
  "Voir": "Ver",
  "Retour à la file": "Voltar à fila",
  "Identité & affectation": "Identidade e afetação",
  "Ouvrir la pièce": "Abrir o documento",
  "Carte pro. / ordre de mission": "Cartão prof. / ordem de missão",
  "Aucune pièce jointe.": "Sem documento anexado.",
  "Valider l'habilitation": "Validar a habilitação",
  "Motif (obligatoire en cas de refus)…": "Motivo (obrigatório em caso de recusa)…",
  "Rejeter la demande": "Recusar o pedido",
  "Indiquez le motif du refus.": "Indique o motivo da recusa.",
  "Demande introuvable.": "Pedido não encontrado.",
  "Corps de contrôle": "Forças de controlo",
  "Définissez les corps proposés à l'inscription — rien n'est codé en dur, tout se règle ici.":
    "Defina as forças propostas na inscrição — nada está fixo no código, tudo se configura aqui.",
  "Corps habilités": "Forças habilitadas",
  "Nom (ex. Police maritime)": "Nome (ex. Polícia marítima)",
  "Code (ex. MARITIME)": "Código (ex. MARITIMA)",
  "Sigle": "Sigla",
  "Aucun corps configuré.": "Nenhuma força configurada.",
  "membre(s)": "membro(s)",
  "Seuls les corps actifs sont proposés lors de l'inscription. Un corps rattaché à des membres ne peut être supprimé.":
    "Apenas as forças ativas são propostas na inscrição. Uma força com membros não pode ser eliminada.",
  "Ouvrir le contrôle": "Abrir o controlo",
  // Noms des corps (renvoyés par l'API)
  "Police de la circulation": "Polícia de Trânsito",
  "Garde Nationale": "Guarda Nacional",
  "Police d'Ordre Public": "Polícia de Ordem Pública",
  "Police Judiciaire": "Polícia Judiciária",
  "Forces Armées": "Forças Armadas",
  "Douanes": "Alfândega",
  ...
  /* ── Amendes & procès-verbaux ── */
  "Infractions": "Infrações",
  "Mes amendes": "As minhas multas",
  "Journal des infractions": "Registo das infrações",
  "Dresser un procès-verbal": "Levantar um auto",
  "Rattachez l'infraction au véhicule contrôlé. L'usager est notifié et pourra régler l'amende par mobile money.":
    "Associe a infração ao veículo controlado. O utente é notificado e poderá pagar a multa por mobile money.",
  "Nouveau PV": "Novo auto",
  "Plaque du véhicule contrôlé": "Matrícula do veículo controlado",
  "Rechercher": "Pesquisar",
  "Aucun véhicule immatriculé pour cette plaque.": "Nenhum veículo matriculado para esta matrícula.",
  "Véhicule concerné (vérifié au contrôle)": "Veículo em causa (verificado no controlo)",
  "Identifié": "Identificado",
  "Changer de véhicule": "Mudar de veículo",
  "Procès-verbal émis.": "Auto emitido.",
  "L'usager a été notifié ; l'amende est désormais payable par mobile money.":
    "O utente foi notificado; a multa é agora paga por mobile money.",
  "Type d'infraction (barème)": "Tipo de infração (tabela)",
  "Lieu du contrôle": "Local do controlo",
  "Ex. Avenida Amílcar Cabral, Bissau": "Ex. Avenida Amílcar Cabral, Bissau",
  "Date / heure": "Data / hora",
  "Maintenant": "Agora",
  "Observations (facultatif)": "Observações (facultativo)",
  "Montant de l'amende": "Montante da multa",
  "Émettre le procès-verbal": "Emitir o auto",
  "À l'émission : l'usager reçoit une notification, le PV s'ajoute au dossier de vie du véhicule, et devient payable par mobile money.":
    "Na emissão: o utente recebe uma notificação, o auto é adicionado ao histórico do veículo e torna-se pagável por mobile money.",
  "Émission impossible.": "Emissão impossível.",
  "Procès-verbal": "Auto",
  "À RÉGLER": "A PAGAR",
  "Montant dû": "Montante em dívida",
  "Infraction": "Infração",
  "PV N°": "Auto N.º",
  "Agent": "Agente",
  "Vérifier le PV": "Verificar o auto",
  "À régler sous 30 jours.": "A pagar em 30 dias.",
  "Le paiement génère une quittance officielle.": "O pagamento gera um recibo oficial.",
  "Voir le journal des infractions": "Ver o registo das infrações",
  "Aperçu du procès-verbal": "Pré-visualização do auto",
  "Identifiez le véhicule et choisissez l'infraction : le PV apparaîtra ici avec son QR de vérification.":
    "Identifique o veículo e escolha a infração: o auto aparecerá aqui com o seu QR de verificação.",
  "Consultez les procès-verbaux de vos véhicules et réglez vos amendes par mobile money.":
    "Consulte os autos dos seus veículos e pague as suas multas por mobile money.",
  "amende(s) à régler": "multa(s) a pagar",
  "Réglez-les pour clôturer les procès-verbaux.": "Pague-as para encerrar os autos.",
  "Aucune amende": "Nenhuma multa",
  "Vos véhicules n'ont aucun procès-verbal. Continuez comme ça !":
    "Os seus veículos não têm qualquer auto. Continue assim!",
  "Payer par mobile money": "Pagar por mobile money",
  "Contester": "Contestar",
  "Télécharger la quittance": "Descarregar o recibo",
  "Contestation en cours d'examen.": "Contestação em análise.",
  "Amende annulée par l'administration.": "Multa anulada pela administração.",
  "Motif de la contestation": "Motivo da contestação",
  "Expliquez pourquoi vous contestez ce procès-verbal.": "Explique por que contesta este auto.",
  "Envoyer la contestation": "Enviar a contestação",
  "Contestation impossible.": "Contestação impossível.",
  "Infractions & amendes": "Infrações e multas",
  "Suivez les procès-verbaux dressés, leur règlement et les recettes.":
    "Acompanhe os autos levantados, o seu pagamento e as receitas.",
  "Dresser un PV": "Levantar um auto",
  "Barème": "Tabela",
  "PV émis": "Autos emitidos",
  "En attente de paiement": "A aguardar pagamento",
  "Contestées": "Contestadas",
  "Recettes": "Receitas",
  "PV, plaque, titulaire…": "Auto, matrícula, titular…",
  "À régler": "A pagar",
  "Soldées": "Pagas",
  "Aucune infraction": "Nenhuma infração",
  "Aucun procès-verbal ne correspond à ce filtre.": "Nenhum auto corresponde a este filtro.",
  "PV": "Auto",
  "Quittance": "Recibo",
  "Rejeter la contestation": "Rejeitar a contestação",
  "Annuler l'amende": "Anular a multa",
  "Dresser un PV pour ce véhicule": "Levantar um auto para este veículo",
  "Barème des infractions": "Tabela das infrações",
  "Définissez les types d'infraction et leurs montants — rien n'est codé en dur, tout se règle ici.":
    "Defina os tipos de infração e os seus montantes — nada está fixo no código, tudo se define aqui.",
  "Types & montants": "Tipos e montantes",
  "Libellé (ex. Feu rouge)": "Designação (ex. Sinal vermelho)",
  "Code (ex. FEU_ROUGE)": "Código (ex. FEU_ROUGE)",
  "Créer": "Criar",
  "Aucun type d'infraction configuré.": "Nenhum tipo de infração configurado.",
  "Modifiez un montant en cliquant sur sa valeur. Seuls les types actifs sont proposés au moment de dresser un PV.":
    "Altere um montante clicando no seu valor. Apenas os tipos ativos são propostos ao levantar um auto.",

  /* ── Statuts d'infraction (libellés backend) ── */
  "Soldée": "Paga",
  "Contestée": "Contestada",
  "Annulée": "Anulada",

  /* ── Barème par défaut ── */
  "Excès de vitesse": "Excesso de velocidade",
  "Défaut d'assurance": "Falta de seguro",
  "Défaut de contrôle technique": "Falta de inspeção técnica",
  "Certificat non présenté": "Certificado não apresentado",
  "Stationnement interdit": "Estacionamento proibido",

  /* ── Notifications d'amende ── */
  "Amende": "Multa",
  "Amende à régler": "Multa a pagar",
  "Amende soldée": "Multa paga",
  "Amende annulée": "Multa anulada",
  "Contestation rejetée": "Contestação rejeitada",

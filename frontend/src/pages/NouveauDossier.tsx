...
export default function NouveauDossier() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setErreur(messageErreur(err, "Création impossible. Vérifiez les informations du véhicule."));
    } finally {
      setChargement(false);
    }
  }
  ...
  return (
    <Layout>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Nouveau dossier — véhicule</CardTitle>
          <CardDescription>
            Renseignez les caractéristiques du véhicule. Vous ajouterez les pièces à l'étape
            suivante.
          </CardDescription>
        </CardHeader>
        <CardContent>
